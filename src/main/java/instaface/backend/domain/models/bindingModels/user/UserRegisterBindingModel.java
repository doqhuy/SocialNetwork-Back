...
import instaface.backend.validations.annotations.Password;
import instaface.backend.validations.annotations.PasswordMatching;
import instaface.backend.validations.annotations.UniqueEmail;
import instaface.backend.validations.annotations.UniqueUsername;
...
public class UserRegisterBindingModel implements Serializable {
    ...
    @NotNull(message = ValidationMessageConstants.USER_INVALID_BIRTH_DAY_MESSAGE)
    ...
    @NotNull(message = ValidationMessageConstants.USER_GENDER_REQUIRED_MESSAGE)
