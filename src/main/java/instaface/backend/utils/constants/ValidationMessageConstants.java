package instaface.backend.utils.constants;
...
public final class ValidationMessageConstants {
    ...
    public static final String USER_INVALID_BIRTH_DAY_MESSAGE = "Birthday is required.";
    public static final String USER_GENDER_REQUIRED_MESSAGE = "Gender is required.";
    public static final String USER_INFO_REQUIRED_MESSAGE = "Info is required.";
}
