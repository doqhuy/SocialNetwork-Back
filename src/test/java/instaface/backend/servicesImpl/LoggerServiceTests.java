...
import instaface.backend.domain.entities.Logger;
import instaface.backend.domain.models.serviceModels.LoggerServiceModel;
import instaface.backend.repositories.LoggerRepository;
...
import instaface.backend.domain.entities.*;
...
public class LoggerServiceTests {
    ...
    public void createComment_whenInputsAreNotValid_throwException(){
        ...
        thrown.expectMessage(ResponseMessageConstants.FAILURE_LOGS_SAVING_MESSAGE);
        // Act
    ...
    public void getLogsByUsername_whenUsernameIsNotValid_throwException() {
        ...
        thrown.expect(CustomException.class);
        thrown.expectMessage(ResponseMessageConstants.SERVER_ERROR_MESSAGE);
    ...
    public void getLogsByUsername_whenNoLogs_throwException() {
        ...
        thrown.expect(CustomException.class);
        thrown.expectMessage(ResponseMessageConstants.FAILURE_LOGS_NOT_FOUND_MESSAGE);
