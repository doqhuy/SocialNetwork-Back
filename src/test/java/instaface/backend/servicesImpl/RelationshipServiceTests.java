...
import instaface.backend.domain.models.serviceModels.RelationshipServiceModel;
import instaface.backend.domain.models.viewModels.relationship.FriendsCandidatesViewModel;
import instaface.backend.repositories.RelationshipRepository;
import instaface.backend.repositories.UserRepository;
import instaface.backend.services.RelationshipService;
...
public class RelationshipServiceTests {
    ...
    public void findAllUserRelationshipsWithStatus_whenUserIdValidAnd2UsersInDbWithStatus1_return2Users() throws Exception {
        ...
        Assert.assertEquals(expected.getUserOne().getUsername(), actual.getUserOne().getUsername());
        Assert.assertEquals(expected.getUserOne().getEmail(), actual.getUserOne().getEmail());
        Assert.assertEquals(expected.getUserOne().getFirstName(), actual.getUserOne().getFirstName());
        Assert.assertEquals(expected.getUserOne().getLastName(), actual.getUserOne().getLastName());
        assertEquals(expected.getStatus(), actual.getStatus());
        Assert.assertEquals(expected.getActionUser().getUsername(), actual.getActionUser().getUsername());
        Assert.assertEquals(expected.getActionUser().getEmail(), actual.getActionUser().getEmail());
