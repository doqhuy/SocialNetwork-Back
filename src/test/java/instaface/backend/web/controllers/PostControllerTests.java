...
import instaface.backend.domain.models.viewModels.comment.CommentAllViewModel;
import instaface.backend.domain.models.viewModels.post.PostAllViewModel;
import instaface.backend.services.PostService;
...
public class PostControllerTests {
    ...
    public void createPost_whenInputsAreValid_createPost() throws Exception {
        ...
        this.mvc
                ...
                .andExpect(jsonPath("$.message").value(ResponseMessageConstants.SUCCESSFUL_CREATE_POST_MESSAGE));
