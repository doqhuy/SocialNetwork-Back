...
import instaface.backend.domain.models.serviceModels.PictureServiceModel;
import instaface.backend.services.PictureService;
...
public class PictureControllerTests {
    ...
    public void removePicture_whenDeletePictureReturnsTrue_deletePost() throws Exception {
        ...
        this.mvc
                ...
                .andExpect(content().contentType(TestUtil.TEXT_PLAIN_UTF8))
                .andExpect(jsonPath("$.success").value("true"))
                .andExpect(jsonPath("$.message").value(ResponseMessageConstants.SUCCESSFUL_PICTURE_DELETE_MESSAGE));
