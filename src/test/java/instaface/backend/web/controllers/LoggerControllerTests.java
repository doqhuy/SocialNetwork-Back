...
import instaface.backend.domain.models.viewModels.logger.LoggerViewModel;
import instaface.backend.services.LoggerService;
import instaface.backend.testUtils.LoggerUtils;
...
import instaface.backend.testUtils.*;
...
public class LoggerControllerTests {
    ...
    public void deleteLogs_whenDeleteAllReturnsTrue_deleteLogs() throws Exception {
        ...
        this.mvc
                ...
                .andExpect(jsonPath("$.message").value(ResponseMessageConstants.SUCCESSFUL_LOGS_DELETING_MESSAGE));
    ...
    public void deleteLogsByName_whenDeleteByNameReturnsTrue_deleteLogs() throws Exception {
        ...
        this.mvc
                ...
                .andExpect(content().contentType(TestUtil.TEXT_PLAIN_UTF8))
                .andExpect(jsonPath("$.success").value("true"))
                .andExpect(jsonPath("$.message").value(ResponseMessageConstants.SUCCESSFUL_USER_LOGS_DELETING_MESSAGE));
