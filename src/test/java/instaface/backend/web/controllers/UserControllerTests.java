...
import instaface.backend.testUtils.TestUtil;
import instaface.backend.testUtils.UsersUtils;
import instaface.backend.utils.constants.ResponseMessageConstants;
import instaface.backend.utils.responseHandler.exceptions.BadRequestException;
...
public class UserControllerTests {
    ...
    public void getAllUsers_when2Users_2Users() throws Exception {
        ...
        this.mvc
                ...
                .andExpect(jsonPath("$[0].username", is("nguyenvana 0")))
                .andExpect(jsonPath("$[0].role", is("ADMIN")))
                .andExpect(jsonPath("$[1].id", is("2")))
                .andExpect(jsonPath("$[1].username", is("nguyenvana 1")))
    ...
    public void getAllUsers_whenGetAllUsersThrowsException_throwCustomException() throws Exception {
        when(this.mockUserService.getAllUsers("1"))
                .thenThrow(new CustomException(ResponseMessageConstants.SERVER_ERROR_MESSAGE));
        ...
        Assert.assertEquals(ResponseMessageConstants.SERVER_ERROR_MESSAGE, resolvedException.getMessage());
    ...
    public void registerUser_whenInputsAreValid_registerUser() throws Exception {
        ...
        this.mvc
                ...
                .andExpect(jsonPath("$.message").value(ResponseMessageConstants.SUCCESSFUL_REGISTER_MESSAGE))
                ...
                .andExpect(jsonPath("$.payload.birthDay").value(userCreateViewModel.getBirthDay()))
                .andExpect(jsonPath("$.payload.gender").value(userCreateViewModel.getGender()))
                .andExpect(jsonPath("$.payload.info").value(userCreateViewModel.getInfo()))
    ...
    public void registerUser_whenPasswordsDontMatch_throwException() throws Exception {
        ...
        Assert.assertEquals(ResponseMessageConstants.PASSWORDS_MISMATCH_ERROR_MESSAGE, resolvedException.getMessage());
    ...
    public void getDetails_whenIdIsValid_returnUser() throws Exception {
        ...
        this.mvc
                ...
                .andExpect(jsonPath("$.birthDay").value(userDetailsViewModel.getBirthDay()))
                .andExpect(jsonPath("$.gender").value(userDetailsViewModel.getGender()))
                .andExpect(jsonPath("$.info").value(userDetailsViewModel.getInfo()))
    ...
    public void updateUser_whenInputsAreValid_returnUser() throws Exception {
        ...
        this.mvc
                ...
                .andExpect(content().contentType(TestUtil.TEXT_PLAIN_UTF8))
                .andExpect(jsonPath("$.success").value("true"))
                .andExpect(jsonPath("$.message").value(ResponseMessageConstants.SUCCESSFUL_USER_PROFILE_EDIT_MESSAGE));
    ...
    public void deleteUser_whenDeleteUserByIdReturnsTrue_deleteUser() throws Exception {
        ...
        this.mvc
                ...
                .andExpect(content().contentType(TestUtil.TEXT_PLAIN_UTF8))
                .andExpect(jsonPath("$.success").value("true"))
                .andExpect(jsonPath("$.message").value(ResponseMessageConstants.SUCCESSFUL_USER_DELETE_MESSAGE));
    ...
    public void promoteUser_whenPromoteUserReturnsTrue_promoteUser() throws Exception {
        ...
        this.mvc
                ...
                .andExpect(content().contentType(TestUtil.TEXT_PLAIN_UTF8))
                .andExpect(jsonPath("$.success").value("true"))
                .andExpect(jsonPath("$.message").value(ResponseMessageConstants.SUCCESSFUL_USER_PROMOTED_MESSAGE));
    ...
    public void promoteUser_whenPromoteUserReturnsFalse_throwException() throws Exception {
        ...
        Assert.assertEquals(ResponseMessageConstants.USER_FAILURE_PROMOTING_MESSAGE, resolvedException.getMessage());
        Assert.assertEquals(CustomException.class, resolvedException.getClass());
    ...
    public void demoteUser_whenDemoteUserReturnsTrue_promoteUser() throws Exception {
        ...
        this.mvc
                ...
                .andExpect(content().contentType(TestUtil.TEXT_PLAIN_UTF8))
                .andExpect(jsonPath("$.success").value("true"))
                .andExpect(jsonPath("$.message").value(ResponseMessageConstants.SUCCESSFUL_USER_DEMOTED_MESSAGE));
    ...
    public void demoteUser_whenPromoteUserReturnsFalse_throwException() throws Exception {
        ...
        Assert.assertEquals(ResponseMessageConstants.USER_FAILURE_DEMOTING_MESSAGE, resolvedException.getMessage());
        Assert.assertEquals(CustomException.class, resolvedException.getClass());
